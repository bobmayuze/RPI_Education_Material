...
print('Sun-to-Jupiter radius ratio:',Sun_to_Jupiter_radius_ratio )

Sun_to_Earth_radius_ratio = (π*Sun_Diameter)/(π*Earth_Diameter)
print('Sun-to-Earth radius ratio:',Sun_to_Earth_radius_ratio )

Jupiter_to_Earth_radius_ratio = (π*Jupiter_Diameter)/(π*Earth_Diameter)
print('Jupiter-to-Earth radius ratio:',Jupiter_to_Earth_radius_ratio )

Jupiter_to_Earth_Sun_distance_ratio = Jupiter_To_Sun/Earth_To_Sun
print('\nJupiter-to-Earth Sun distance ratio:',Jupiter_to_Earth_Sun_distance_ratio)

Sun_to_Jupiter_volume_ratio = (4/3*π*(Sun_Diameter/2)**3)/(4/3*π*(Jupiter_Diameter/2)**3)
print('Sun-to-Jupiter volume ratio:',Sun_to_Jupiter_volume_ratio)

Sun_to_Earth_volume_ratio = (4/3*π*(Sun_Diameter/2)**3)/(4/3*π*(Earth_Diameter/2)**3)
print('Sun-to-Earth volume ratio:',Sun_to_Earth_volume_ratio)

Jupiter_to_Earth_volume_ratio = (4/3*π*(Jupiter_Diameter/2)**3)/(4/3*π*(Earth_Diameter/2)**3)
print('Jupiter-to-Earth volume ratio:',Jupiter_to_Earth_volume_ratio)

Sun_to_Earth_light_travel_time_in_minutes = Earth_To_Sun/Speed_Of_Light/60
print('\nSun to Earth light travel time in minutes:',Sun_to_Earth_light_travel_time_in_minutes)

Sun_to_Jupiter_light_travel_time_in_minutes = Jupiter_To_Sun/Speed_Of_Light/60
print('Sun to Jupiter light travel time in minutes:',Sun_to_Jupiter_light_travel_time_in_minutes)
